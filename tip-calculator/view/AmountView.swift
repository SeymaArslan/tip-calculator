...
class AmountView: UIView {
    ...
    private lazy var titleLabel: UILabel = {  // aşağıda text in değerini title yaptığımızda (String veri yerine) private let'ken hata aldık bu yüzden lazy var yaptık
