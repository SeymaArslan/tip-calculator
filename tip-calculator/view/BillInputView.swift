...
class BillInputView: UIView {
    ...
    private let headerView: HeaderView = {
        let view = HeaderView()
        view.configure(topText: "Fatura", bottomText: "tutarı")
        return view
    }()
    ...
    private func layout() {
        ...
        headerView.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(textFieldContainerView.snp.leading).offset(-24)  // offset padding işlemi
        }
    ...
    private func layout() {
       addSubview(stackView)
        ...
        topSpacerView.snp.makeConstraints { make in
            make.height.equalTo(bottomSpaceView)
        }
    }
